...
interface PledgeFormProps {
  members: Member[];
  projects: Project[];
  newPledgeMemberId: string | undefined;
  setNewPledgeMemberId: (id: string | undefined) => void;
  newPledgeProjectId: string | undefined;
  setNewPledgeProjectId: (id: string | undefined) => void;
  newPledgeAmount: string;
  setNewPledgeAmount: (amount: string) => void;
  newPledgeDueDate: Date | undefined;
  setNewPledgeDueDate: (date: Date | undefined) => void;
  handleRecordPledge: () => Promise<void>;
